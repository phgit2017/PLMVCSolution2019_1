...
namespace DataAccess.Repository.PL
{
    public class PLRepository <T> : IPLRepository<T> where T : class
    {
        protected IIOBalanceDBV3Entities Db;

        public PLRepository(IIOBalanceDBV3Entities dataContext)
        {
            Db = dataContext;
        }
